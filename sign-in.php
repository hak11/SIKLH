...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Sign-In to <b>B3</b> KLHK</a>
            <small>Note : Kementrian Lingkungan Hidup dan Kehutanan</small>
            <small></small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="action/sign-in/validasi.php">
